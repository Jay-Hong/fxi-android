...
/** Fixed executor identity; fresh attempt admission remains a future writer responsibility. */
...
/**
 * R/N/L receipt type only, distinct from the existing rotation receipt. No writer returns it yet.
