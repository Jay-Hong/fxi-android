...
class ControlIssuanceStructureTest {
    ...
    companion object {
        ...
        private val expected = mapOf(
            "registerPrepared" to mapOf(control + "ControlCommandTracking.kt" to 1, control + "ControlRecordStore.kt" to 6),
            ...
            "ControlRecordStore" to mapOf(control + "ControlRecordStore.kt" to 1, control + "NamespaceSettlementTransition.kt" to 1,
                ...
                control + "ControlLifecycle.kt" to 1, control + "DemandAuthTransition.kt" to 1),
