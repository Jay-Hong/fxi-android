...
class ControlOwnerStructureTest {
    ...
    companion object {
        private val expectedReferences = mapOf(
            ...
            "main/java/com/jay/fxi/data/entitlements/control/RecoverHoldTransition.kt" to listOf(
            ...
            "main/java/com/jay/fxi/data/entitlements/control/RetiredNullSettlementTransition.kt" to listOf(
                "import com.jay.fxi.data.entitlements.DataStoreAccessEpochStore.Companion.ENTRY_SEPARATOR",
                "import com.jay.fxi.data.entitlements.DataStoreAccessEpochStore.Companion.KRX_EPOCH",
                "import com.jay.fxi.data.entitlements.DataStoreAccessEpochStore.Companion.MAY_CONTAIN_KRX",
                "import com.jay.fxi.data.entitlements.DataStoreAccessEpochStore.Companion.MAY_CONTAIN_PREMIUM",
